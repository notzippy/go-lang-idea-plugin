...
import com.notzippy.intellij.go.stubs.GoPackageClauseStub;
...
public class GoPackageClauseImpl extends GoStubbedElementImpl<GoPackageClauseStub> implements GoPackageClause {
  ...
  public GoPackageClauseImpl(@NotNull GoPackageClauseStub stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public GoPackageClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
