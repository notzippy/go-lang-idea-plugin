...
import com.notzippy.intellij.go.stubs.GoParamDefinitionStub;
...
public class GoParamDefinitionImpl extends GoNamedElementImpl<GoParamDefinitionStub> implements GoParamDefinition {
  ...
  public GoParamDefinitionImpl(@NotNull GoParamDefinitionStub stub, @NotNull IStubElementType type) {
    super(stub, type);
  }

  public GoParamDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
