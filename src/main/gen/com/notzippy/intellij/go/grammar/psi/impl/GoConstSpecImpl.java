...
public class GoConstSpecImpl extends GoStubbedElementImpl<GoConstSpecStub> implements GoConstSpec {
  ...
  public GoConstSpecImpl(@NotNull GoConstSpecStub stub, @NotNull IStubElementType type) {
    super(stub, type);
  }
  ...
  @Override
  public void deleteDefinition(@NotNull GoConstDefinition definitionToDelete) {
