...
abstract public class GoCodeInsightFixtureTestCase extends LightPlatformCodeInsightFixtureTestCase {
  ...
  public static final String GO_TEST_SDK_VERSION = "1.1.2";
  public static final String GO_TEST_SDK = "Go " + GO_TEST_SDK_VERSION;
  ...
  protected void tearDown() throws Exception {
    try {
      ...
      Sdk old = ProjectJdkTable.getInstance().findJdk(GO_TEST_SDK);
      if (old != null) {
  ...
  private static DefaultLightProjectDescriptor createMockProjectDescriptor() {
    return new DefaultLightProjectDescriptor() {
      ...
      @Override
      public Sdk getSdk() {
        return createMockSdk(GO_TEST_SDK_VERSION);
      }
  ...
  private static Sdk createMockSdk(@NotNull String version) {
    ...
    ProjectJdkImpl sdk = new ProjectJdkImpl(GO_TEST_SDK, sdkType, homePath, version);
